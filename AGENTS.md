...
<!-- BEGIN:implement-design -->
# Implement Design (Figma to Code)

Translates Figma designs into production-ready code with 1:1 visual fidelity. Use this workflow when implementing UI from Figma files, when user mentions "implement design", "generate code", "implement component", "build Figma design", provides Figma URLs, or asks to build components matching Figma specs.
...
- Figma MCP server must be connected and accessible
  ...
  - If the tools are not available, the Figma MCP server may not be enabled. Guide the user to enable it and restart if needed.
